...
@router.post("/bulk")
async def create_appointments_bulk(
    payload: AppointmentBulkIn, user=Depends(forbid_demo_write)
):
...
async def update_appointment(
    aid: str, payload: AppointmentIn, user=Depends(forbid_demo_write)
):
