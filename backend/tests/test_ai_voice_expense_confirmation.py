...
from services.ai_service import AiService, EXPENSE_CONFIRM_THRESHOLD
...
def test_add_offer_richiede_sempre_conferma_indipendentemente_dal_canale():
    assert service.requires_confirmation("add_offer", {"amount": 5}, channel="voice") is True
    assert service.requires_confirmation("add_offer", {"amount": 5}, channel="chat") is True
