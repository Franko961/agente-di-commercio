...
def test_admin_delete_user_cancella_labbonamento_e_i_dati_collegati(monkeypatch):
    fake_db = FakeDb()
    fake_db.users.docs.append({"id": "vittima", "email": "vittima@test.it", "stripe_subscription_id": "sub_123"})
    fake_db.clients.docs.append({"id": "c1", "user_id": "vittima", "company_name": "Cliente della vittima"})
    fake_db.clients.docs.append({"id": "c2", "user_id": "altro-utente", "company_name": "Non toccare"})
