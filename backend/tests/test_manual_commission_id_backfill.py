"""
Verifica startup_service.backfill_manual_commission_ids: i documenti
...
import services.startup_service as startup_service_mod
from services.startup_service import backfill_manual_commission_ids
