...
MAX_UNIT_PRICE = 10_000_000         # prezzo/costo unitario (riga offerta/ordine o a listino prodotto)
MAX_EXPENSE_AMOUNT = 1_000_000      # importo di una singola spesa
MAX_MONETARY_TARGET = 100_000_000   # obiettivi di fatturato/provvigioni, valore stimato di un lead
...
MAX_BULK_IMPORT_ITEMS = 2000   # righe in un import CSV/Excel in blocco (clienti o prodotti)
