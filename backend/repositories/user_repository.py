...
class UserRepository:
    ...
    async def find_by_attendance_kiosk_token_hash(self, token_hash: str) -> Optional[dict]:
        ...
        return await self.collection.find_one({"attendance_kiosk_token_hash": token_hash}, {"_id": 0, "password_hash": 0})
