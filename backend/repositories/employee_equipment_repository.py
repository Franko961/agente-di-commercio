...
class EmployeeEquipmentRepository:
    ...
    async def update(self, eqid: str, user_id: str, employee_id: str, data: dict) -> bool:
    ...
    async def delete(self, eqid: str, user_id: str, employee_id: str) -> None:
        await self.collection.delete_one({"id": eqid, "user_id": user_id, "employee_id": employee_id})
