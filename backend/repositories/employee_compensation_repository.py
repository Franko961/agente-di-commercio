...
class EmployeeCompensationRepository:
    ...
    async def update(self, cid: str, user_id: str, employee_id: str, data: dict) -> bool:
    ...
    async def delete(self, cid: str, user_id: str, employee_id: str) -> None:
        await self.collection.delete_one({"id": cid, "user_id": user_id, "employee_id": employee_id})
