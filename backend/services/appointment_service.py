...
class AppointmentService:
    ...
    async def _push_to_google_calendar_safe(
        self, user_id: str, appointment: dict, action: str, google_event_id=None
    ) -> None:
        ...
        try:
            ...
            logger.error(
                f"Sync Google Calendar ({action}) fallita per user {user_id}: {e}"
            )
