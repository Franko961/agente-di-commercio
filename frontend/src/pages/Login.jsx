...
export default function Login() {
  ...
  const [email, setEmail] = useState("agente@demo.it");
          ...
          <div className="w-full max-w-md fade-up">
            ...
            <p className="text-[14px] text-[#52525B] leading-relaxed mb-8 max-w-sm">
              {mode === "login"
                ...
                : "Crea il tuo profilo agente. Multi-mandato, multi-listino, sempre con te."}
            </p>
            ...
            <form onSubmit={submit} className="space-y-4">
              {mode === "register" && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[#E4E4E1] rounded-md px-3 py-2.5 text-[14px] focus:outline-none focus:border-[#0A192F] transition-colors"
                  />
                </div>
              )}
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white border border-[#E4E4E1] rounded-md px-3 py-2.5 text-[14px] pr-10 focus:outline-none focus:border-[#0A192F] transition-colors"
                  />
              ...
              <button
                ...
                className="w-full bg-[#0A192F] hover:bg-[#172A45] text-white font-medium py-3 rounded-md transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50"
              >
