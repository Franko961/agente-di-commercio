  ...
  return (
    <IllustrationFrame bg="#0A192F0D">
      <svg viewBox="0 0 160 120" className="w-28 h-28">
        ...
        <path d="M25,90 Q60,30 85,55 T135,25" fill="none" stroke="#B23E00" strokeWidth="3" strokeDasharray="6 5" strokeLinecap="round" />
        <g>
        ...
        <g>
          <circle cx="135" cy="25" r="10" fill="#B23E00" />
  ...
  return (
    <IllustrationFrame bg="#B23E000D">
      <svg viewBox="0 0 160 120" className="w-28 h-28">
        ...
        <path d="M70 55 l4 9 9 4 -9 4 -4 9 -4 -9 -9 -4 9 -4 z" fill="#B23E00" />
        <path d="M118 30 l2.5 5.5 5.5 2.5 -5.5 2.5 -2.5 5.5 -2.5 -5.5 -5.5 -2.5 5.5 -2.5 z" fill="#B23E00" />
...
function ProvvigioniIllustration() {
  return (
    <IllustrationFrame bg="#0596690D">
      <svg viewBox="0 0 160 120" className="w-28 h-28">
        <ellipse cx="55" cy="88" rx="26" ry="9" fill="#B23E00" />
        <ellipse cx="55" cy="80" rx="26" ry="9" fill="#FFB27A" />
        <ellipse cx="55" cy="72" rx="26" ry="9" fill="#B23E00" />
  ...
  return (
    <IllustrationFrame bg="#0A192F0D">
      <svg viewBox="0 0 160 120" className="w-28 h-28">
        ...
        <rect x="62" y="38" width="35" height="5" rx="2.5" fill="#B23E00" />
  ...
  return (
    <IllustrationFrame bg="#B23E000D">
      <svg viewBox="0 0 160 120" className="w-28 h-28">
        ...
        <path d="M96,20 l7,14 15,2 -11,10 3,15 -14,-7 -14,7 3,-15 -11,-10 15,-2 z" fill="#B23E00" />
      </svg>
    </IllustrationFrame>
  );
}
  ...
  return (
    <IllustrationFrame bg="#0A192F0D">
      <svg viewBox="0 0 160 120" className="w-28 h-28">
        ...
        <circle cx="60" cy="60" r="34" fill="none" stroke="#B23E00" strokeWidth="10" strokeLinecap="round"
    ...
    <div className="min-h-screen bg-[#F9F9F8] flex flex-col">
      ...
      <main className="flex-1 px-6 py-16 max-w-5xl mx-auto w-full">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-[#B23E00] mb-4">Perché SalesFly</div>
              ...
              <Reveal key={title} delay={(i % 3) * 80}>
                ...
                >
                  ...
                  <div className="mt-4">
                    ...
                    {blogSlug && (
                      <span className="inline-flex items-center gap-1 text-[12px] text-[#B23E00] font-medium mt-3">
