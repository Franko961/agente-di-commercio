...
export default function AIAssistant() {
  const [messages, setMessages] = useState([
    { role: "assistant", text: "Ciao! Sono il tuo assistente commerciale. Posso suggerirti i clienti più importanti da visitare, analizzare il fatturato e darti consigli pratici. Cosa vuoi sapere?" }
  ]);
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="border-b border-[#E4E4E1] pb-6 mb-6">
        ...
        <p className="text-[14px] text-[#52525B] mt-2">Powered by Gemini 3 Flash · Risponde in italiano sui tuoi dati.</p>
      </div>
