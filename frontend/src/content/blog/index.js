...
import { article as annunciAgenti } from "./articles/annunci-agenti-di-commercio-settore-regione";
import { article as organizzareSettimana } from "./articles/organizzare-settimana-agente-plurimandatario";
import { article as scadenzeFiscali } from "./articles/scadenze-fiscali-calendario-agente-di-commercio";
import { article as ferieMalattia } from "./articles/ferie-malattia-agente-di-commercio-partita-iva";
...
import { article as cambiareMandante } from "./articles/cambiare-mandante-portafoglio-provvigioni";
import { article as whatsappCrm } from "./articles/whatsapp-crm-agente-di-commercio";
import { article as codiceAteco } from "./articles/codice-ateco-agente-di-commercio";
import { article as prescrizioneProvvigioni } from "./articles/prescrizione-provvigioni-agente-di-commercio";
import { article as regimeForfettarioAgente } from "./articles/regime-forfettario-agente-di-commercio";
import { article as recessoContrattoAgenzia } from "./articles/recesso-contratto-di-agenzia";
import { article as fatturaProvvigioni } from "./articles/fattura-provvigioni-agente-di-commercio";
import { article as costoCarburante } from "./articles/costo-carburante-agente-di-commercio";
import { article as mandanteNonPaga } from "./articles/mandante-non-paga-provvigioni-cosa-fare";
import { article as percentualeProvvigioni } from "./articles/percentuale-provvigioni-agente-di-commercio";
import { article as accontoProvvigionale } from "./articles/acconto-provvigionale-anticipo-provvigioni-agente";

const allArticles = [calcoloProvvigioni, aiCrmAutomazione, enasarco, giroVisite, speseDeducibili, multiMandante, crmMobile, crmDaTelefono, salesflyVsHubspot, migliorCrmVenditori, crmAiVenditori, aumentareProvvigioni, daExcelAlCrm, implementareInDueMinuti, contrattoDiAgenzia, rimborsoTasseStudio, bonusScolasticoFigli, minimaliMassimali, inquadramentoAgente, catalogoDigitale, ritenutaAcconto, firr, agenteSportivo, deducibilitaAuto, crmItaliano, percorsoOttimizzato, verificaVies, stornoProvvigioni, annunciAgenti, organizzareSettimana, scadenzeFiscali, ferieMalattia, iscrizioneEnasarco, pensioneEnasarco, primi90Giorni, provvigioniScalari, crmGratuito, migrareCrmGenerico, costruirePortafoglio, followUpCommerciale, clienteRescindeOrdini, dipendenteVsPartitaIva, cambiareMandante, whatsappCrm, codiceAteco, prescrizioneProvvigioni, regimeForfettarioAgente, recessoContrattoAgenzia, fatturaProvvigioni, costoCarburante, mandanteNonPaga, percentualeProvvigioni, accontoProvvigionale];
