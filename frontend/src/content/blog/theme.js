...
export const THEME_RULES = [
  ...
  [(s) => s.includes("acconto-provvigionale"), "ANTICIPI", "1673837552444-7a90431588fe", "Vendita"],
  [(s) => s.includes("percentuale-provvigioni"), "PERCENTUALI", "1769028871759-8099b7474ac4", "Vendita"],
